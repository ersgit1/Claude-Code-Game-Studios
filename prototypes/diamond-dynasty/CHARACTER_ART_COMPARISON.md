...
original alpha sprites: nine side/back three-quarter batting frames and seven
pitching frames.
...
`art/concepts/original-batter-side-swing-concept-v6.png` using the existing
...
> Rebuild the batter as nine evenly spaced side/back three-quarter poses:
> ready, load, stride, heel plant, swing, contact, extension, high follow-through,
> and controlled reset. Keep the fictional cream, navy, and coral player, hard
> 16-bit pixel clusters, identical scale and baseline, flat magenta key, and
> complete uncropped bats; no real likeness, logo, text, watermark, copied

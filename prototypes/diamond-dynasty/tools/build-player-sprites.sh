...
BATTER_SOURCE="$ROOT_DIR/art/concepts/original-batter-depth-stance-concept-v7.png"
...
# The source is a regular 3x3 grid. Each crop keeps a stable, foreshortened
# home-plate-camera silhouette and baseline; the slightly larger cell recreates
# the close foreground scale of a classic pitcher/batter screen without copying
# a commercial player, uniform, or pose.
...
render_sprite "$BATTER_SOURCE" batter-8 "418:418:836:836" "114:108" "120:112" "(ow-iw)/2:112-ih" "$BATTER_KEY"

...
ffmpeg -y -loglevel error \
  ...
  -filter_complex \
    "[0:v]scale=768:768:flags=neighbor[left];[1:v][2:v]overlay=90:65:format=auto[field];[field][3:v]overlay=1:106:format=auto,scale=768:672:flags=neighbor,pad=768:768:0:48:color=0x07101f[right];[left][right]hstack=inputs=2" \
  -frames:v 1 "$OUTPUT"
